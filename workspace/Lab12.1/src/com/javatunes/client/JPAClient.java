...
//    client.queryById(2L);
  ...
  private void queryById(Long id) {
    // TODO: Create the entity manager (EM) - a short-lived "inexpensive" object, used for a single transaction
    EntityManager em = null;
    em.getTransaction().begin();
    
    // TODO: Use the EntityManger to find the MusicItem by the given id
    MusicItem item = null;
